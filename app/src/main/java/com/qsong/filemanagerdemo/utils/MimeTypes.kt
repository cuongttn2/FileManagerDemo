...
object MimeTypes {
    ...
    /** Custom MimeTypes for this app*/
    /** Custom 'metadata' types for this app*/
    enum class MetaData(val extensions: Array<String>, val mimeType: String) {
        /** Meta */
        META(arrayOf(".meta"), "metadata")
